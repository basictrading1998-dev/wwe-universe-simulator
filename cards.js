...
function buildShowSchedulerHeader() {
    ...
    row.innerHTML = `
        ...
        <div style="display:flex; gap:8px; align-items:center;">
            <input type="text" id="eventNameInput" placeholder="Name" value="" style="padding:6px 10px; border-radius:6px; border:1px solid #cbd5e1; font-size:0.8rem; font-weight:600; outline:none; width:180px; background:white; color:#1e293b;">
